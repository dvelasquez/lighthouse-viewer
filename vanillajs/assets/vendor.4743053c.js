var xe=Object.defineProperty,Ee=Object.defineProperties;var ke=Object.getOwnPropertyDescriptors;var ue=Object.getOwnPropertySymbols;var Ae=Object.prototype.hasOwnProperty,Ce=Object.prototype.propertyIsEnumerable;var oe=(r,e,t)=>e in r?xe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,ee=(r,e)=>{for(var t in e||(e={}))Ae.call(e,t)&&oe(r,t,e[t]);if(ue)for(var t of ue(e))Ce.call(e,t)&&oe(r,t,e[t]);return r},ge=(r,e)=>Ee(r,ke(e));var me=(r,e,t)=>(oe(r,typeof e!="symbol"?e+"":e,t),t);/**
 * @license
 ...
 */const F="\u2026",J="\xA0";const fe="data:image/jpeg;base64,",N={PASS:{label:"pass",minScore:.9},AVERAGE:{label:"average",minScore:.5},FAIL:{label:"fail"},ERROR:{label:"error"}},Se=["com","co","gov","edu","ac","org","go","gob","or","net","in","ne","nic","gouv","web","spb","blog","jus","kiev","mil","wi","qc","ca","bel","on"],x=class{static get PASS_THRESHOLD(){return .9}static get MS_DISPLAY_VALUE(){return`%10d${J}ms`}static prepareReportResult(e){const t=JSON.parse(JSON.stringify(e));t.configSettings.locale||(t.configSettings.locale="en"),t.configSettings.formFactor||(t.configSettings.formFactor=t.configSettings.emulatedFormFactor);for(const a of Object.values(t.audits))if((a.scoreDisplayMode==="not_applicable"||a.scoreDisplayMode==="not-applicable")&&(a.scoreDisplayMode="notApplicable"),a.details&&((a.details.type===void 0||a.details.type==="diagnostic")&&(a.details.type="debugdata"),a.details.type==="filmstrip"))for(const l of a.details.items)l.data.startsWith(fe)||(l.data=fe+l.data);if(typeof t.categories!="object")throw new Error("No categories provided.");const n=new Map,[o]=t.lighthouseVersion.split(".").map(Number),i=t.categories.performance;if(o<9&&i){t.categoryGroups||(t.categoryGroups={}),t.categoryGroups.hidden={title:""};for(const a of i.auditRefs)a.group?["load-opportunities","diagnostics"].includes(a.group)&&delete a.group:a.group="hidden"}for(const a of Object.values(t.categories))a.auditRefs.forEach(l=>{!l.relevantAudits||l.relevantAudits.forEach(s=>{const c=n.get(s)||[];c.push(l),n.set(s,c)})}),a.auditRefs.forEach(l=>{const s=t.audits[l.id];l.result=s,n.has(l.id)&&(l.relevantMetrics=n.get(l.id)),t.stackPacks&&t.stackPacks.forEach(c=>{c.descriptions[l.id]&&(l.stackPacks=l.stackPacks||[],l.stackPacks.push({title:c.title,iconDataURL:c.iconDataURL,description:c.descriptions[l.id]}))})});return t}static showAsPassed(e){switch(e.scoreDisplayMode){case"manual":case"notApplicable":return!0;case"error":case"informative":return!1;case"numeric":case"binary":default:return Number(e.score)>=N.PASS.minScore}}static calculateRating(e,t){if(t==="manual"||t==="notApplicable")return N.PASS.label;if(t==="error")return N.ERROR.label;if(e===null)return N.FAIL.label;let n=N.FAIL.label;return e>=N.PASS.minScore?n=N.PASS.label:e>=N.AVERAGE.minScore&&(n=N.AVERAGE.label),n}static splitMarkdownCodeSpans(e){const t=[],n=e.split(/`(.*?)`/g);for(let o=0;o<n.length;o++){const i=n[o];if(!i)continue;const a=o%2!==0;t.push({isCode:a,text:i})}return t}static splitMarkdownLink(e){const t=[],n=e.split(/\[([^\]]+?)\]\((https?:\/\/.*?)\)/g);for(;n.length;){const[o,i,a]=n.splice(0,3);o&&t.push({isLink:!1,text:o}),i&&a&&t.push({isLink:!0,text:i,linkHref:a})}return t}static getURLDisplayName(e,t){t=t||{numPathParts:void 0,preserveQuery:void 0,preserveHost:void 0};const n=t.numPathParts!==void 0?t.numPathParts:2,o=t.preserveQuery!==void 0?t.preserveQuery:!0,i=t.preserveHost||!1;let a;if(e.protocol==="about:"||e.protocol==="data:")a=e.href;else{a=e.pathname;const s=a.split("/").filter(c=>c.length);n&&s.length>n&&(a=F+s.slice(-1*n).join("/")),i&&(a=`${e.host}/${a.replace(/^\//,"")}`),o&&(a=`${a}${e.search}`)}const l=64;if(a=a.replace(/([a-f0-9]{7})[a-f0-9]{13}[a-f0-9]*/g,`$1${F}`),a=a.replace(/([a-zA-Z0-9-_]{9})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])[a-zA-Z0-9-_]{10,}/g,`$1${F}`),a=a.replace(/(\d{3})\d{6,}/g,`$1${F}`),a=a.replace(/\u2026+/g,F),a.length>l&&a.includes("?")&&(a=a.replace(/\?([^=]*)(=)?.*/,`?$1$2${F}`),a.length>l&&(a=a.replace(/\?.*/,`?${F}`))),a.length>l){const s=a.lastIndexOf(".");s>=0?a=a.slice(0,l-1-(a.length-s))+`${F}${a.slice(s)}`:a=a.slice(0,l-1)+F}return a}static parseURL(e){const t=new URL(e);return{file:x.getURLDisplayName(t),hostname:t.hostname,origin:t.origin}}static createOrReturnURL(e){return e instanceof URL?e:new URL(e)}static getTld(e){const t=e.split(".").slice(-2);return Se.includes(t[0])?`.${t.join(".")}`:`.${t[t.length-1]}`}static getRootDomain(e){const t=x.createOrReturnURL(e).hostname,o=x.getTld(t).split(".");return t.split(".").slice(-o.length).join(".")}static getEmulationDescriptions(e){let t,n,o;const i=e.throttling;switch(e.throttlingMethod){case"provided":o=n=t=x.i18n.strings.throttlingProvided;break;case"devtools":{const{cpuSlowdownMultiplier:l,requestLatencyMs:s}=i;t=`${x.i18n.formatNumber(l)}x slowdown (DevTools)`,n=`${x.i18n.formatNumber(s)}${J}ms HTTP RTT, ${x.i18n.formatNumber(i.downloadThroughputKbps)}${J}Kbps down, ${x.i18n.formatNumber(i.uploadThroughputKbps)}${J}Kbps up (DevTools)`,o=(()=>s===150*3.75&&i.downloadThroughputKbps===1.6*1024*.9&&i.uploadThroughputKbps===750*.9)()?x.i18n.strings.runtimeSlow4g:x.i18n.strings.runtimeCustom;break}case"simulate":{const{cpuSlowdownMultiplier:l,rttMs:s,throughputKbps:c}=i;t=`${x.i18n.formatNumber(l)}x slowdown (Simulated)`,n=`${x.i18n.formatNumber(s)}${J}ms TCP RTT, ${x.i18n.formatNumber(c)}${J}Kbps throughput (Simulated)`,o=(()=>s===150&&c===1.6*1024)()?x.i18n.strings.runtimeSlow4g:x.i18n.strings.runtimeCustom;break}default:o=t=n=x.i18n.strings.runtimeUnknown}return{deviceEmulation:{mobile:x.i18n.strings.runtimeMobileEmulation,desktop:x.i18n.strings.runtimeDesktopEmulation}[e.formFactor]||x.i18n.strings.runtimeNoEmulation,cpuThrottling:t,networkThrottling:n,summary:o}}static filterRelevantLines(e,t,n){if(t.length===0)return e.slice(0,n*2+1);const o=3,i=new Set;return t=t.sort((a,l)=>(a.lineNumber||0)-(l.lineNumber||0)),t.forEach(({lineNumber:a})=>{let l=a-n,s=a+n;for(;l<1;)l++,s++;i.has(l-o-1)&&(l-=o);for(let c=l;c<=s;c++){const d=c;i.add(d)}}),e.filter(a=>i.has(a.lineNumber))}static isPluginCategory(e){return e.startsWith("lighthouse-plugin-")}static shouldDisplayAsFraction(e){return e==="timespan"||e==="snapshot"}static calculateCategoryFraction(e){let t=0,n=0,o=0,i=0;for(const a of e.auditRefs){const l=x.showAsPassed(a.result);if(!(a.group==="hidden"||a.result.scoreDisplayMode==="manual"||a.result.scoreDisplayMode==="notApplicable")){if(a.result.scoreDisplayMode==="informative"){l||++o;continue}++t,i+=a.weight,l&&n++}}return{numPassed:n,numPassableAudits:t,numInformative:o,totalWeight:i}}};let h=x;me(h,"i18n",null);h.reportJson=null;h.getUniqueSuffix=(()=>{let r=0;return function(){return r++}})();const ze={varianceDisclaimer:"Values are estimated and may vary. The [performance score is calculated](https://web.dev/performance-scoring/) directly from these metrics.",calculatorLink:"See calculator.",showRelevantAudits:"Show audits relevant to:",opportunityResourceColumnLabel:"Opportunity",opportunitySavingsColumnLabel:"Estimated Savings",errorMissingAuditInfo:"Report error: no audit information",errorLabel:"Error!",warningHeader:"Warnings: ",warningAuditsGroupTitle:"Passed audits but with warnings",passedAuditsGroupTitle:"Passed audits",notApplicableAuditsGroupTitle:"Not applicable",manualAuditsGroupTitle:"Additional items to manually check",toplevelWarningsMessage:"There were issues affecting this run of Lighthouse:",crcInitialNavigation:"Initial Navigation",crcLongestDurationLabel:"Maximum critical path latency:",snippetExpandButtonLabel:"Expand snippet",snippetCollapseButtonLabel:"Collapse snippet",lsPerformanceCategoryDescription:"[Lighthouse](https://developers.google.com/web/tools/lighthouse/) analysis of the current page on an emulated mobile network. Values are estimated and may vary.",labDataTitle:"Lab Data",thirdPartyResourcesLabel:"Show 3rd-party resources",viewTreemapLabel:"View Treemap",viewTraceLabel:"View Trace",viewOriginalTraceLabel:"View Original Trace",dropdownPrintSummary:"Print Summary",dropdownPrintExpanded:"Print Expanded",dropdownCopyJSON:"Copy JSON",dropdownSaveHTML:"Save as HTML",dropdownSaveJSON:"Save as JSON",dropdownViewer:"Open in Viewer",dropdownSaveGist:"Save as Gist",dropdownDarkTheme:"Toggle Dark Theme",runtimeSettingsDevice:"Device",runtimeSettingsNetworkThrottling:"Network throttling",runtimeSettingsCPUThrottling:"CPU throttling",runtimeSettingsUANetwork:"User agent (network)",runtimeSettingsBenchmark:"CPU/Memory Power",runtimeSettingsAxeVersion:"Axe version",footerIssue:"File an issue",runtimeNoEmulation:"No emulation",runtimeMobileEmulation:"Emulated Moto G4",runtimeDesktopEmulation:"Emulated Desktop",runtimeUnknown:"Unknown",runtimeSingleLoad:"Single page load",runtimeAnalysisWindow:"Initial page load",runtimeSingleLoadTooltip:"This data is taken from a single page load, as opposed to field data summarizing many sessions.",throttlingProvided:"Provided by environment",show:"Show",hide:"Hide",expandView:"Expand view",collapseView:"Collapse view",runtimeSlow4g:"Slow 4G throttling",runtimeCustom:"Custom throttling"};h.UIStrings=ze;function Le(r){const e=r.createFragment(),t=r.createElement("style");t.append(`
  ...
  `),e.append(t);const n=r.createElement("div","lh-3p-filter"),o=r.createElement("label","lh-3p-filter-label"),i=r.createElement("input","lh-3p-filter-input");i.setAttribute("type","checkbox"),i.setAttribute("checked","");const a=r.createElement("span","lh-3p-ui-string");a.append("Show 3rd party resources");const l=r.createElement("span","lh-3p-filter-count");return o.append(" ",i," ",a," (",l,") "),n.append(" ",o," "),e.append(n),e}function Me(r){const e=r.createFragment(),t=r.createElement("div","lh-audit"),n=r.createElement("details","lh-expandable-details"),o=r.createElement("summary"),i=r.createElement("div","lh-audit__header lh-expandable-details__summary"),a=r.createElement("span","lh-audit__score-icon"),l=r.createElement("span","lh-audit__title-and-text"),s=r.createElement("span","lh-audit__title"),c=r.createElement("span","lh-audit__display-text");l.append(" ",s," ",c," ");const d=r.createElement("div","lh-chevron-container");i.append(" ",a," ",l," ",d," "),o.append(" ",i," ");const u=r.createElement("div","lh-audit__description"),p=r.createElement("div","lh-audit__stackpacks");return n.append(" ",o," ",u," ",p," "),t.append(" ",n," "),e.append(t),e}function Te(r){const e=r.createFragment(),t=r.createElement("div","lh-category-header"),n=r.createElement("div","lh-score__gauge");n.setAttribute("role","heading"),n.setAttribute("aria-level","2");const o=r.createElement("div","lh-category-header__description");return t.append(" ",n," ",o," "),e.append(t),e}function Fe(r){const e=r.createFragment(),t=r.createElementNS("http://www.w3.org/2000/svg","svg","lh-chevron");t.setAttribute("viewBox","0 0 100 100");const n=r.createElementNS("http://www.w3.org/2000/svg","g","lh-chevron__lines"),o=r.createElementNS("http://www.w3.org/2000/svg","path","lh-chevron__line lh-chevron__line-left");o.setAttribute("d","M10 50h40");const i=r.createElementNS("http://www.w3.org/2000/svg","path","lh-chevron__line lh-chevron__line-right");return i.setAttribute("d","M90 50H50"),n.append(" ",o," ",i," "),t.append(" ",n," "),e.append(t),e}function Ne(r){const e=r.createFragment(),t=r.createElement("div","lh-audit-group"),n=r.createElement("details","lh-clump"),o=r.createElement("summary"),i=r.createElement("div","lh-audit-group__summary"),a=r.createElement("div","lh-audit-group__header"),l=r.createElement("span","lh-audit-group__title"),s=r.createElement("span","lh-audit-group__itemcount");a.append(" ",l," ",s," "," "," ");const c=r.createElement("div","lh-clump-toggle"),d=r.createElement("span","lh-clump-toggletext--show"),u=r.createElement("span","lh-clump-toggletext--hide");return c.append(" ",d," ",u," "),i.append(" ",a," ",c," "),o.append(" ",i," "),n.append(" ",o," "),t.append(" "," ",n," "),e.append(t),e}function De(r){const e=r.createFragment(),t=r.createElement("div","lh-crc-container"),n=r.createElement("style");n.append(`
  ...
  `),e.append(t);const n=r.createElement("div","lh-header-container"),o=r.createElement("div","lh-scores-wrapper-placeholder");return n.append(" ",o," "),e.append(n),e}function Be(r){const e=r.createFragment(),t=r.createElement("div","lh-metric"),n=r.createElement("div","lh-metric__innerwrap"),o=r.createElement("div","lh-metric__icon"),i=r.createElement("span","lh-metric__title"),a=r.createElement("div","lh-metric__value"),l=r.createElement("div","lh-metric__description");return n.append(" ",o," ",i," ",a," ",l," "),t.append(" ",n," "),e.append(t),e}function Ve(r){const e=r.createFragment(),t=r.createElement("div","lh-audit lh-audit--load-opportunity"),n=r.createElement("details","lh-expandable-details"),o=r.createElement("summary"),i=r.createElement("div","lh-audit__header"),a=r.createElement("div","lh-load-opportunity__cols"),l=r.createElement("div","lh-load-opportunity__col lh-load-opportunity__col--one"),s=r.createElement("span","lh-audit__score-icon"),c=r.createElement("div","lh-audit__title");l.append(" ",s," ",c," ");const d=r.createElement("div","lh-load-opportunity__col lh-load-opportunity__col--two"),u=r.createElement("div","lh-load-opportunity__sparkline"),p=r.createElement("div","lh-sparkline"),m=r.createElement("div","lh-sparkline__bar");p.append(m),u.append(" ",p," ");const f=r.createElement("div","lh-audit__display-text"),b=r.createElement("div","lh-chevron-container");d.append(" ",u," ",f," ",b," "),a.append(" ",l," ",d," "),i.append(" ",a," "),o.append(" ",i," ");const v=r.createElement("div","lh-audit__description"),g=r.createElement("div","lh-audit__stackpacks");return n.append(" ",o," ",v," ",g," "),t.append(" ",n," "),e.append(t),e}function Ge(r){const e=r.createFragment(),t=r.createElement("div","lh-load-opportunity__header lh-load-opportunity__cols"),n=r.createElement("div","lh-load-opportunity__col lh-load-opportunity__col--one"),o=r.createElement("div","lh-load-opportunity__col lh-load-opportunity__col--two");return t.append(" ",n," ",o," "),e.append(t),e}function We(r){const e=r.createFragment(),t=r.createElement("div","lh-scorescale"),n=r.createElement("span","lh-scorescale-range lh-scorescale-range--fail");n.append("0\u201349");const o=r.createElement("span","lh-scorescale-range lh-scorescale-range--average");o.append("50\u201389");const i=r.createElement("span","lh-scorescale-range lh-scorescale-range--pass");return i.append("90\u2013100"),t.append(" ",n," ",o," ",i," "),e.append(t),e}function je(r){const e=r.createFragment(),t=r.createElement("style");t.append(`
    .lh-scores-container {
      display: flex;
  ...
  `),e.append(t);const n=r.createElement("div","lh-scores-wrapper"),o=r.createElement("div","lh-scores-container"),i=r.createElement("div","lh-pyro"),a=r.createElement("div","lh-pyro-before"),l=r.createElement("div","lh-pyro-after");return i.append(" ",a," ",l," "),o.append(" ",i," "),n.append(" ",o," "),e.append(n),e}function qe(r){const e=r.createFragment(),t=r.createElement("div","lh-snippet"),n=r.createElement("style");return n.append(`
          :root {
    ...
    `),t.append(" ",n," "),e.append(t),e}function Ke(r){const e=r.createFragment(),t=r.createElement("div","lh-snippet__snippet"),n=r.createElement("div","lh-snippet__snippet-inner");return t.append(" ",n," "),e.append(t),e}function Je(r){const e=r.createFragment(),t=r.createElement("div","lh-snippet__header"),n=r.createElement("div","lh-snippet__title"),o=r.createElement("div","lh-snippet__node"),i=r.createElement("button","lh-snippet__toggle-expand"),a=r.createElement("span","lh-snippet__btn-label-collapse lh-snippet__show-if-expanded"),l=r.createElement("span","lh-snippet__btn-label-expand lh-snippet__show-if-collapsed");return i.append(" ",a," ",l," "),t.append(" ",n," ",o," ",i," "),e.append(t),e}function Ye(r){const e=r.createFragment(),t=r.createElement("div","lh-snippet__line"),n=r.createElement("div","lh-snippet__line-number"),o=r.createElement("div","lh-snippet__line-icon"),i=r.createElement("code");return t.append(" ",n," ",o," ",i," "),e.append(t),e}function Qe(r){const e=r.createFragment(),t=r.createElement("style");return t.append(`/**
 * @license
 * Copyright 2017 The Lighthouse Authors. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),e.append(t),e}function Xe(r){const e=r.createFragment(),t=r.createElement("style");t.append(`
    .lh-topbar {
      position: sticky;
      top: 0;
      left: 0;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e,t){this._document=e,this._lighthouseChannel="unknown",this._componentCache=new Map,this.rootEl=t}createElement(e,t){const n=this._document.createElement(e);if(t)for(const o of t.split(/\s+/))o&&n.classList.add(o);return n}createElementNS(e,t,n){const o=this._document.createElementNS(e,t);if(n)for(const i of n.split(/\s+/))i&&o.classList.add(i);return o}createFragment(){return this._document.createDocumentFragment()}createTextNode(e){return this._document.createTextNode(e)}createChildOf(e,t,n){const o=this.createElement(t,n);return e.appendChild(o),o}createComponent(e){let t=this._componentCache.get(e);if(t){const o=t.cloneNode(!0);return this.findAll("style",o).forEach(i=>i.remove()),o}return t=et(this,e),this._componentCache.set(e,t),t.cloneNode(!0)}clearComponentCache(){this._componentCache.clear()}convertMarkdownLinkSnippets(e){const t=this.createElement("span");for(const n of h.splitMarkdownLink(e)){if(!n.isLink){t.appendChild(this._document.createTextNode(n.text));continue}const o=new URL(n.linkHref);["https://developers.google.com","https://web.dev"].includes(o.origin)&&(o.searchParams.set("utm_source","lighthouse"),o.searchParams.set("utm_medium",this._lighthouseChannel));const a=this.createElement("a");a.rel="noopener",a.target="_blank",a.textContent=n.text,this.safelySetHref(a,o.href),t.appendChild(a)}return t}safelySetHref(e,t){if(t=t||"",t.startsWith("#")){e.href=t;return}const n=["https:","http:"];let o;try{o=new URL(t)}catch{}o&&n.includes(o.protocol)&&(e.href=o.href)}safelySetBlobHref(e,t){if(t.type!=="text/html"&&t.type!=="application/json")throw new Error("Unsupported blob type");const n=URL.createObjectURL(t);e.href=n}convertMarkdownCodeSnippets(e){const t=this.createElement("span");for(const n of h.splitMarkdownCodeSpans(e))if(n.isCode){const o=this.createElement("code");o.textContent=n.text,t.appendChild(o)}else t.appendChild(this._document.createTextNode(n.text));return t}setLighthouseChannel(e){this._lighthouseChannel=e}document(){return this._document}isDevTools(){return!!this._document.querySelector(".lh-devtools")}find(e,t){const n=t.querySelector(e);if(n===null)throw new Error(`query ${e} not found`);return n}findAll(e,t){return Array.from(t.querySelectorAll(e))}fireEventOn(e,t=this._document,n){const o=new CustomEvent(e,n?{detail:n}:void 0);t.dispatchEvent(o)}saveFile(e,t){const n=this.createElement("a");n.download=t,this.safelySetBlobHref(n,e),this._document.body.appendChild(n),n.click(),this._document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),500)}}/**
 * @license
 * Copyright 2017 The Lighthouse Authors. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class we{static initTree(e){let t=0;const n=Object.keys(e);return n.length>0&&(t=e[n[0]].request.startTime),{tree:e,startTime:t,transferSize:0}}static createSegment(e,t,n,o,i,a){const l=e[t],s=Object.keys(e),c=s.indexOf(t)===s.length-1,d=!!l.children&&Object.keys(l.children).length>0,u=Array.isArray(i)?i.slice(0):[];return typeof a!="undefined"&&u.push(!a),{node:l,isLastChild:c,hasChildren:d,startTime:n,transferSize:o+l.request.transferSize,treeMarkers:u}}static createChainNode(e,t,n){const o=e.createComponent("crcChain");e.find(".lh-crc-node",o).setAttribute("title",t.node.request.url);const i=e.find(".lh-crc-node__tree-marker",o);t.treeMarkers.forEach(c=>{c?(i.appendChild(e.createElement("span","lh-tree-marker lh-vert")),i.appendChild(e.createElement("span","lh-tree-marker"))):(i.appendChild(e.createElement("span","lh-tree-marker")),i.appendChild(e.createElement("span","lh-tree-marker")))}),t.isLastChild?(i.appendChild(e.createElement("span","lh-tree-marker lh-up-right")),i.appendChild(e.createElement("span","lh-tree-marker lh-right"))):(i.appendChild(e.createElement("span","lh-tree-marker lh-vert-right")),i.appendChild(e.createElement("span","lh-tree-marker lh-right"))),t.hasChildren?i.appendChild(e.createElement("span","lh-tree-marker lh-horiz-down")):i.appendChild(e.createElement("span","lh-tree-marker lh-right"));const a=t.node.request.url,l=n.renderTextURL(a),s=e.find(".lh-crc-node__tree-value",o);if(s.appendChild(l),!t.hasChildren){const{startTime:c,endTime:d,transferSize:u}=t.node.request,p=e.createElement("span","lh-crc-node__chain-duration");p.textContent=" - "+h.i18n.formatMilliseconds((d-c)*1e3)+", ";const m=e.createElement("span","lh-crc-node__chain-duration");m.textContent=h.i18n.formatBytesToKiB(u,.01),s.appendChild(p),s.appendChild(m)}return o}static buildTree(e,t,n,o,i,a){if(o.appendChild(Y.createChainNode(e,n,a)),n.node.children)for(const l of Object.keys(n.node.children)){const s=Y.createSegment(n.node.children,l,n.startTime,n.transferSize,n.treeMarkers,n.isLastChild);Y.buildTree(e,t,s,o,i,a)}}static render(e,t,n){const o=e.createComponent("crc"),i=e.find(".lh-crc",o);e.find(".lh-crc-initial-nav",o).textContent=h.i18n.strings.crcInitialNavigation,e.find(".lh-crc__longest_duration_label",o).textContent=h.i18n.strings.crcLongestDurationLabel,e.find(".lh-crc__longest_duration",o).textContent=h.i18n.formatMilliseconds(t.longestChain.duration);const a=Y.initTree(t.chains);for(const l of Object.keys(a.tree)){const s=Y.createSegment(a.tree,l,a.startTime,a.transferSize);Y.buildTree(e,o,s,i,t,n)}return e.find(".lh-crc-container",o)}}const Y=we;/**
 * @license Copyright 2019 The Lighthouse Authors. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
 */const R={ALWAYS:0,WHEN_COLLAPSED:1,WHEN_EXPANDED:2},D={CONTENT_NORMAL:0,CONTENT_HIGHLIGHTED:1,PLACEHOLDER:2,MESSAGE:3},nt={[D.CONTENT_NORMAL]:["lh-snippet__line--content"],[D.CONTENT_HIGHLIGHTED]:["lh-snippet__line--content","lh-snippet__line--content-highlighted"],[D.PLACEHOLDER]:["lh-snippet__line--placeholder"],[D.MESSAGE]:["lh-snippet__line--message"]};function be(r,e){return{line:r.find(t=>t.lineNumber===e),previousLine:r.find(t=>t.lineNumber===e-1)}}function rt(r,e){return r.filter(t=>t.lineNumber===e)}function ve(r){return h.filterRelevantLines(r.lines,r.lineMessages,2)}class M{static renderHeader(e,t,n,o){const a=ve(t).length<t.lines.length,l=e.createComponent("snippetHeader");e.find(".lh-snippet__title",l).textContent=t.title;const{snippetCollapseButtonLabel:s,snippetExpandButtonLabel:c}=h.i18n.strings;e.find(".lh-snippet__btn-label-collapse",l).textContent=s,e.find(".lh-snippet__btn-label-expand",l).textContent=c;const d=e.find(".lh-snippet__toggle-expand",l);return a?d.addEventListener("click",()=>o()):d.remove(),t.node&&e.isDevTools()&&e.find(".lh-snippet__node",l).appendChild(n.renderNode(t.node)),l}static renderSnippetLine(e,t,{content:n,lineNumber:o,truncated:i,contentType:a,visibility:l}){const s=e.createComponent("snippetLine"),c=e.find(".lh-snippet__line",s),{classList:d}=c;nt[a].forEach(m=>d.add(m)),l===R.WHEN_COLLAPSED?d.add("lh-snippet__show-if-collapsed"):l===R.WHEN_EXPANDED&&d.add("lh-snippet__show-if-expanded");const u=n+(i?"\u2026":""),p=e.find(".lh-snippet__line code",c);return a===D.MESSAGE?p.appendChild(e.convertMarkdownLinkSnippets(u)):p.textContent=u,e.find(".lh-snippet__line-number",c).textContent=o.toString(),c}static renderMessage(e,t,n){return M.renderSnippetLine(e,t,{lineNumber:" ",content:n.message,contentType:D.MESSAGE})}static renderOmittedLinesPlaceholder(e,t,n){return M.renderSnippetLine(e,t,{lineNumber:"\u2026",content:"",visibility:n,contentType:D.PLACEHOLDER})}static renderSnippetContent(e,t,n){const o=e.createComponent("snippetContent"),i=e.find(".lh-snippet__snippet-inner",o);return n.generalMessages.forEach(a=>i.append(M.renderMessage(e,t,a))),i.append(M.renderSnippetLines(e,t,n)),o}static renderSnippetLines(e,t,n){const{lineMessages:o,generalMessages:i,lineCount:a,lines:l}=n,s=ve(n),c=i.length>0&&o.length===0,d=e.createFragment();let u=!1;for(let p=1;p<=a;p++){const{line:m,previousLine:f}=be(l,p),{line:b,previousLine:v}=be(s,p),g=!!b;if(!!v&&!g&&(u=!0),g&&u&&(d.append(M.renderOmittedLinesPlaceholder(e,t,R.WHEN_COLLAPSED)),u=!1),!m&&!!f||!m&&p===1){const E=!s.some(z=>z.lineNumber>p)||p===1;d.append(M.renderOmittedLinesPlaceholder(e,t,E?R.WHEN_EXPANDED:R.ALWAYS)),u=!1}if(!m)continue;const y=rt(o,p),k=y.length>0||c,A=Object.assign({},m,{contentType:k?D.CONTENT_HIGHLIGHTED:D.CONTENT_NORMAL,visibility:b?R.ALWAYS:R.WHEN_EXPANDED});d.append(M.renderSnippetLine(e,t,A)),y.forEach(S=>{d.append(M.renderMessage(e,t,S))})}return d}static render(e,t,n){const o=e.createComponent("snippet"),i=e.find(".lh-snippet",o),a=M.renderHeader(e,t,n,()=>i.classList.toggle("lh-snippet--expanded")),l=M.renderSnippetContent(e,o,t);return i.append(a,l),i}}/**
 * @license Copyright 2020 The Lighthouse Authors. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
 */function ot(r,e){return e.left<=r.width&&0<=e.right&&e.top<=r.height&&0<=e.bottom}function _e(r,e,t){return r<e?e:r>t?t:r}function it(r){return{x:r.left+r.width/2,y:r.top+r.height/2}}class O{static getScreenshotPositions(e,t,n){const o=it(e),i=_e(o.x-t.width/2,0,n.width-t.width),a=_e(o.y-t.height/2,0,n.height-t.height);return{screenshot:{left:i,top:a},clip:{left:e.left-i,top:e.top-a}}}static renderClipPathInScreenshot(e,t,n,o,i){const a=e.find("clipPath",t),l=`clip-${h.getUniqueSuffix()}`;a.id=l,t.style.clipPath=`url(#${l})`;const s=n.top/i.height,c=s+o.height/i.height,d=n.left/i.width,u=d+o.width/i.width,p=[`0,0             1,0            1,${s}          0,${s}`,`0,${c}     1,${c}    1,1               0,1`,`0,${s}        ${d},${s} ${d},${c} 0,${c}`,`${u},${s} 1,${s}       1,${c}       ${u},${c}`];for(const m of p){const f=e.createElementNS("http://www.w3.org/2000/svg","polygon");f.setAttribute("points",m),a.append(f)}}static installFullPageScreenshot(e,t){e.style.setProperty("--element-screenshot-url",`url('${t.data}')`)}static installOverlayFeature(e){const{dom:t,rootEl:n,overlayContainerEl:o,fullPageScreenshot:i}=e,a="lh-screenshot-overlay--enabled";n.classList.contains(a)||(n.classList.add(a),n.addEventListener("click",l=>{const s=l.target;if(!s)return;const c=s.closest(".lh-node > .lh-element-screenshot");if(!c)return;const d=t.createElement("div","lh-element-screenshot__overlay");o.append(d);const u={width:d.clientWidth*.95,height:d.clientHeight*.8},p={width:Number(c.dataset.rectWidth),height:Number(c.dataset.rectHeight),left:Number(c.dataset.rectLeft),right:Number(c.dataset.rectLeft)+Number(c.dataset.rectWidth),top:Number(c.dataset.rectTop),bottom:Number(c.dataset.rectTop)+Number(c.dataset.rectHeight)},m=O.render(t,i.screenshot,p,u);if(!m){d.remove();return}d.appendChild(m),d.addEventListener("click",()=>d.remove())}))}static _computeZoomFactor(e,t){const o={x:t.width/e.width,y:t.height/e.height},i=.75*Math.min(o.x,o.y);return Math.min(1,i)}static render(e,t,n,o){if(!ot(t,n))return null;const i=e.createComponent("elementScreenshot"),a=e.find("div.lh-element-screenshot",i);a.dataset.rectWidth=n.width.toString(),a.dataset.rectHeight=n.height.toString(),a.dataset.rectLeft=n.left.toString(),a.dataset.rectTop=n.top.toString();const l=this._computeZoomFactor(n,o),s={width:o.width/l,height:o.height/l};s.width=Math.min(t.width,s.width);const c={width:s.width*l,height:s.height*l},d=O.getScreenshotPositions(n,s,{width:t.width,height:t.height}),u=e.find("div.lh-element-screenshot__content",a);u.style.top=`-${c.height}px`;const p=e.find("div.lh-element-screenshot__image",a);p.style.width=c.width+"px",p.style.height=c.height+"px",p.style.backgroundPositionY=-(d.screenshot.top*l)+"px",p.style.backgroundPositionX=-(d.screenshot.left*l)+"px",p.style.backgroundSize=`${t.width*l}px ${t.height*l}px`;const m=e.find("div.lh-element-screenshot__element-marker",a);m.style.width=n.width*l+"px",m.style.height=n.height*l+"px",m.style.left=d.clip.left*l+"px",m.style.top=d.clip.top*l+"px";const f=e.find("div.lh-element-screenshot__mask",a);return f.style.width=c.width+"px",f.style.height=c.height+"px",O.renderClipPathInScreenshot(e,f,d.clip,n,s),a}}/**
 * @license
 * Copyright 2017 The Lighthouse Authors. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class le extends ae{render(e,t={}){const n=this.dom.createElement("div","lh-category");n.id=e.id,n.appendChild(this.renderCategoryHeader(e,t));const o=e.auditRefs,i=o.filter(c=>c.result.scoreDisplayMode!=="manual"),a=this._renderAudits(i,t);n.appendChild(a);const l=o.filter(c=>c.result.scoreDisplayMode==="manual"),s=this.renderClump("manual",{auditRefs:l,description:e.manualDescription});return n.appendChild(s),n}renderCategoryScore(e,t){if(e.score===null)return super.renderScoreGauge(e,t);const n=this.dom.createComponent("gaugePwa"),o=this.dom.find("a.lh-gauge--pwa__wrapper",n),i=n.querySelector("svg");if(!i)throw new Error("no SVG element found in PWA score gauge template");le._makeSvgReferencesUnique(i);const a=this._getGroupIds(e.auditRefs),l=this._getPassingGroupIds(e.auditRefs);if(l.size===a.size)o.classList.add("lh-badged--all");else for(const s of l)o.classList.add(`lh-badged--${s}`);return this.dom.find(".lh-gauge__label",n).textContent=e.title,o.title=this._getGaugeTooltip(e.auditRefs,t),n}_getGroupIds(e){const t=e.map(n=>n.group).filter(n=>!!n);return new Set(t)}_getPassingGroupIds(e){const t=this._getGroupIds(e);for(const n of e)!h.showAsPassed(n.result)&&n.group&&t.delete(n.group);return t}_getGaugeTooltip(e,t){const n=this._getGroupIds(e),o=[];for(const i of n){const a=e.filter(d=>d.group===i),l=a.length,s=a.filter(d=>h.showAsPassed(d.result)).length,c=t[i].title;o.push(`${c}: ${s}/${l}`)}return o.join(", ")}_renderAudits(e,t){const n=this.renderUnexpandableClump(e,t),o=this._getPassingGroupIds(e);for(const i of o)this.dom.find(`.lh-audit-group--${i}`,n).classList.add("lh-badged");return n}static _makeSvgReferencesUnique(e){const t=e.querySelector("defs");if(!t)return;const n=h.getUniqueSuffix(),o=t.querySelectorAll("[id]");for(const i of o){const a=i.id,l=`${a}-${n}`;i.id=l;const s=e.querySelectorAll(`use[href="#${a}"]`);for(const d of s)d.setAttribute("href",`#${l}`);const c=e.querySelectorAll(`[fill="url(#${a})"]`);for(const d of c)d.setAttribute("fill",`url(#${l})`)}}}/**
 * @license
 * Copyright 2017 The Lighthouse Authors. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class pt{constructor(e){this._dom=e,this._opts={}}renderReport(e,t,n){if(!this._dom.rootEl&&t){console.warn("Please adopt the new report API in renderer/api.js.");const i=t.closest(".lh-root");i?this._dom.rootEl=i:(t.classList.add("lh-root","lh-vars"),this._dom.rootEl=t)}else this._dom.rootEl&&t&&(this._dom.rootEl=t);n&&(this._opts=n),this._dom.setLighthouseChannel(e.configSettings.channel||"unknown");const o=h.prepareReportResult(e);return this._dom.rootEl.textContent="",this._dom.rootEl.appendChild(this._renderReport(o)),this._dom.rootEl}_renderReportTopbar(e){const t=this._dom.createComponent("topbar"),n=this._dom.find("a.lh-topbar__url",t);return n.textContent=e.finalUrl,n.title=e.finalUrl,this._dom.safelySetHref(n,e.finalUrl),t}_renderReportHeader(){const e=this._dom.createComponent("heading"),t=this._dom.createComponent("scoresWrapper");return this._dom.find(".lh-scores-wrapper-placeholder",e).replaceWith(t),e}_renderReportFooter(e){const t=this._dom.createComponent("footer");return this._renderMetaBlock(e,t),this._dom.find(".lh-footer__version_issue",t).textContent=h.i18n.strings.footerIssue,this._dom.find(".lh-footer__version",t).textContent=e.lighthouseVersion,t}_renderMetaBlock(e,t){var u;const n=h.getEmulationDescriptions(e.configSettings||{}),o=e.userAgent.match(/(\w*Chrome\/[\d.]+)/),i=Array.isArray(o)?o[1].replace("/"," ").replace("Chrome","Chromium"):"Chromium",a=e.configSettings.channel,l=e.environment.benchmarkIndex.toFixed(0),s=(u=e.environment.credits)==null?void 0:u["axe-core"],c=[["date",`Captured at ${h.i18n.formatDateTime(e.fetchTime)}`],["devices",`${n.deviceEmulation} with Lighthouse ${e.lighthouseVersion}`,`${h.i18n.strings.runtimeSettingsBenchmark}: ${l}
${h.i18n.strings.runtimeSettingsCPUThrottling}: ${n.cpuThrottling}`+(s?`
${h.i18n.strings.runtimeSettingsAxeVersion}: ${s}`:"")],["samples-one",h.i18n.strings.runtimeSingleLoad,h.i18n.strings.runtimeSingleLoadTooltip],["stopwatch",h.i18n.strings.runtimeAnalysisWindow],["networkspeed",`${n.summary}`,`${h.i18n.strings.runtimeSettingsNetworkThrottling}: ${n.networkThrottling}`],["chrome",`Using ${i}`+(a?` with ${a}`:""),`${h.i18n.strings.runtimeSettingsUANetwork}: "${e.environment.networkUserAgent}"`]],d=this._dom.find(".lh-meta__items",t);for(const[p,m,f]of c){const b=this._dom.createChildOf(d,"li","lh-meta__item");if(b.textContent=m,f){b.classList.add("lh-tooltip-boundary");const v=this._dom.createChildOf(b,"div","lh-tooltip");v.textContent=f}b.classList.add("lh-report-icon",`lh-report-icon--${p}`)}}_renderReportWarnings(e){if(!e.runWarnings||e.runWarnings.length===0)return this._dom.createElement("div");const t=this._dom.createComponent("warningsToplevel"),n=this._dom.find(".lh-warnings__msg",t);n.textContent=h.i18n.strings.toplevelWarningsMessage;const o=this._dom.find("ul",t);for(const i of e.runWarnings)o.appendChild(this._dom.createElement("li")).appendChild(this._dom.convertMarkdownLinkSnippets(i));return t}_renderScoreGauges(e,t,n){var l,s;const o=[],i=[],a=[];for(const c of Object.values(e.categories)){const d=n[c.id]||t,u=d.renderCategoryScore(c,e.categoryGroups||{},{gatherMode:e.gatherMode}),p=this._dom.find("a.lh-gauge__wrapper, a.lh-fraction__wrapper",u);p&&(this._dom.safelySetHref(p,`#${c.id}`),p.addEventListener("click",m=>{if(!p.matches('[href^="#"]'))return;const f=p.getAttribute("href"),b=this._dom.rootEl;if(!f||!b)return;const v=this._dom.find(f,b);m.preventDefault(),v.scrollIntoView()}),(s=(l=this._opts).onPageAnchorRendered)==null||s.call(l,p)),h.isPluginCategory(c.id)?a.push(u):d.renderCategoryScore===t.renderCategoryScore?o.push(u):i.push(u)}return[...o,...i,...a]}_renderReport(e){var v;const t=new ct(e.configSettings.locale,ee(ee({},h.UIStrings),e.i18n.rendererFormattedStrings));h.i18n=t,h.reportJson=e;const n=((v=e.audits["full-page-screenshot"])==null?void 0:v.details)&&e.audits["full-page-screenshot"].details.type==="full-page-screenshot"?e.audits["full-page-screenshot"].details:void 0,o=new lt(this._dom,{fullPageScreenshot:n}),i=new ae(this._dom,o),a={performance:new dt(this._dom,o),pwa:new le(this._dom,o)},l=this._dom.createElement("div");l.appendChild(this._renderReportHeader());const s=this._dom.createElement("div","lh-container"),c=this._dom.createElement("div","lh-report");c.appendChild(this._renderReportWarnings(e));let d;Object.keys(e.categories).length===1?l.classList.add("lh-header--solo-category"):d=this._dom.createElement("div","lh-scores-header");const p=this._dom.createElement("div");if(p.classList.add("lh-scorescale-wrap"),p.append(this._dom.createComponent("scorescale")),d){const g=this._dom.find(".lh-scores-container",l);d.append(...this._renderScoreGauges(e,i,a)),g.appendChild(d),g.appendChild(p);const _=this._dom.createElement("div","lh-sticky-header");_.append(...this._renderScoreGauges(e,i,a)),s.appendChild(_)}const m=c.appendChild(this._dom.createElement("div","lh-categories")),f={gatherMode:e.gatherMode};for(const g of Object.values(e.categories)){const _=a[g.id]||i;_.dom.createChildOf(m,"div","lh-category-wrapper").appendChild(_.render(g,e.categoryGroups,f))}i.injectFinalScreenshot(m,e.audits,p);const b=this._dom.createFragment();return this._opts.omitGlobalStyles||b.append(this._dom.createComponent("styles")),this._opts.omitTopbar||b.appendChild(this._renderReportTopbar(e)),b.appendChild(s),s.appendChild(l),s.appendChild(c),c.appendChild(this._renderReportFooter(e)),n&&O.installFullPageScreenshot(this._dom.rootEl,n.screenshot),b}}/**
 * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
 */function te(r,e){const t=r.rootEl;typeof e=="undefined"?t.classList.toggle("lh-dark"):t.classList.toggle("lh-dark",e)}/**
 * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
 */const ht=typeof btoa!="undefined"?btoa:r=>Buffer.from(r).toString("base64"),ut=typeof atob!="undefined"?atob:r=>Buffer.from(r,"base64").toString();async function gt(r,e){let t=new TextEncoder().encode(r);if(e.gzip)if(typeof CompressionStream!="undefined"){const i=new CompressionStream("gzip"),a=i.writable.getWriter();a.write(t),a.close();const l=await new Response(i.readable).arrayBuffer();t=new Uint8Array(l)}else t=window.pako.gzip(r);let n="";const o=5e3;for(let i=0;i<t.length;i+=o)n+=String.fromCharCode(...t.subarray(i,i+o));return ht(n)}function mt(r,e){const t=ut(r),n=Uint8Array.from(t,o=>o.charCodeAt(0));return e.gzip?window.pako.ungzip(n,{to:"string"}):new TextDecoder().decode(n)}const ft={toBase64:gt,fromBase64:mt};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(r){return Array.from(r.tBodies[0].rows)}class St{constructor(e,t={}){this.json,this._dom=e,this._opts=t,this._topbar=t.omitTopbar?null:new xt(this,e),this.onMediaQueryChange=this.onMediaQueryChange.bind(this)}initFeatures(e){this.json=e,this._topbar&&(this._topbar.enable(e),this._topbar.resetUIState()),this._setupMediaQueryListeners(),this._setupThirdPartyFilter(),this._setupElementScreenshotOverlay(this._dom.rootEl);const t=this._dom.isDevTools()||this._opts.disableDarkMode||this._opts.disableAutoDarkModeAndFireworks;!t&&window.matchMedia("(prefers-color-scheme: dark)").matches&&te(this._dom,!0);const o=["performance","accessibility","best-practices","seo"].every(s=>{const c=e.categories[s];return c&&c.score===1}),i=this._opts.disableFireworks||this._opts.disableAutoDarkModeAndFireworks;if(o&&!i&&(this._enableFireworks(),t||te(this._dom,!0)),e.categories.performance&&e.categories.performance.auditRefs.some(s=>Boolean(s.group==="metrics"&&e.audits[s.id].errorMessage))){const s=this._dom.find("input.lh-metrics-toggle__input",this._dom.rootEl);s.checked=!0}this.json.audits["script-treemap-data"]&&this.json.audits["script-treemap-data"].details&&this.addButton({text:h.i18n.strings.viewTreemapLabel,icon:"treemap",onClick:()=>wt(this.json)}),this._opts.onViewTrace&&this.addButton({text:e.configSettings.throttlingMethod==="simulate"?h.i18n.strings.viewOriginalTraceLabel:h.i18n.strings.viewTraceLabel,onClick:()=>{var s,c;return(c=(s=this._opts).onViewTrace)==null?void 0:c.call(s)}}),this._opts.getStandaloneReportHTML&&this._dom.find('a[data-action="save-html"]',this._dom.rootEl).classList.remove("lh-hidden");for(const s of this._dom.findAll("[data-i18n]",this._dom.rootEl)){const d=s.getAttribute("data-i18n");s.textContent=h.i18n.strings[d]}}addButton(e){const t=this._dom.rootEl.querySelector(".lh-audit-group--metrics");if(!t)return;let n=t.querySelector(".lh-buttons");n||(n=this._dom.createChildOf(t,"div","lh-buttons"));const o=["lh-button"];e.icon&&(o.push("lh-report-icon"),o.push(`lh-report-icon--${e.icon}`));const i=this._dom.createChildOf(n,"button",o.join(" "));return i.textContent=e.text,i.addEventListener("click",e.onClick),i}resetUIState(){this._topbar&&this._topbar.resetUIState()}getReportHtml(){if(!this._opts.getStandaloneReportHTML)throw new Error("`getStandaloneReportHTML` is not set");return this.resetUIState(),this._opts.getStandaloneReportHTML()}saveAsGist(){throw new Error("Cannot save as gist from base report")}_enableFireworks(){this._dom.find(".lh-scores-container",this._dom.rootEl).classList.add("lh-score100")}_setupMediaQueryListeners(){const e=self.matchMedia("(max-width: 500px)");e.addListener(this.onMediaQueryChange),this.onMediaQueryChange(e)}_resetUIState(){this._topbar&&this._topbar.resetUIState()}onMediaQueryChange(e){this._dom.rootEl.classList.toggle("lh-narrow",e.matches)}_setupThirdPartyFilter(){const e=["uses-rel-preconnect","third-party-facades"],t=["legacy-javascript"];Array.from(this._dom.rootEl.querySelectorAll("table.lh-table")).filter(i=>i.querySelector("td.lh-table-column--url, td.lh-table-column--source-location")).filter(i=>{const a=i.closest(".lh-audit");if(!a)throw new Error(".lh-table not within audit");return!e.includes(a.id)}).forEach(i=>{const a=Ct(i),l=this._getThirdPartyRows(a,this.json.finalUrl),s=this._dom.createComponent("3pFilter"),c=this._dom.find("input",s);c.addEventListener("change",m=>{const f=m.target instanceof HTMLInputElement&&!m.target.checked;let b=!0,v=a[0];for(;v;){const g=f&&l.includes(v);do v.classList.toggle("lh-row--hidden",g),v.classList.toggle("lh-row--even",!g&&b),v.classList.toggle("lh-row--odd",!g&&!b),v=v.nextElementSibling;while(v&&v.classList.contains("lh-sub-item-row"));g||(b=!b)}}),this._dom.find(".lh-3p-filter-count",s).textContent=`${l.length}`,this._dom.find(".lh-3p-ui-string",s).textContent=h.i18n.strings.thirdPartyResourcesLabel;const d=l.length===a.length,u=!l.length;if((d||u)&&(this._dom.find("div.lh-3p-filter",s).hidden=!0),!i.parentNode)return;i.parentNode.insertBefore(s,i);const p=i.closest(".lh-audit");if(!p)throw new Error(".lh-table not within audit");t.includes(p.id)&&!d&&c.click()})}_setupElementScreenshotOverlay(e){const t=this.json.audits["full-page-screenshot"]&&this.json.audits["full-page-screenshot"].details&&this.json.audits["full-page-screenshot"].details.type==="full-page-screenshot"&&this.json.audits["full-page-screenshot"].details;!t||O.installOverlayFeature({dom:this._dom,rootEl:e,overlayContainerEl:e,fullPageScreenshot:t})}_getThirdPartyRows(e,t){const n=[],o=h.getRootDomain(t);for(const i of e){if(i.classList.contains("lh-sub-item-row"))continue;const a=i.querySelector("div.lh-text__url");if(!a)continue;const l=a.dataset.url;!l||!(h.getRootDomain(l)!==o)||n.push(i)}return n}_saveFile(e){const t=e.type.match("json")?".json":".html",n=At.getLhrFilenamePrefix(this.json)+t;this._opts.onSaveFileOverride?this._opts.onSaveFileOverride(e,n):this._dom.saveFile(e,n)}}/**
 * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
 */function Lt(r,e={}){const t=document.createElement("article");t.classList.add("lh-root","lh-vars");const n=new tt(t.ownerDocument,t);return new pt(n).renderReport(r,t,e),new St(n,e).initFeatures(r),t}export{Lt as r};
